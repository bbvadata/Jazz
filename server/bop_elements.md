...
A c++ std:vector that also works as an iterator of Locator strings. (Possibly: none, one or many.)
...
The operators are:
  ...
  - (..) : Depends on context, it can be a function call == a tuple, a cast, or an operator precedence grouping.
...
a ->				// Put a (if a already exists and has a put locator, this is possible)
...
C-style comments: /* ... */ and // ... to end of line.
