	...
	// Methods on attributes.
		...
		*/
		...
		/** \brief Align a pointer (as uintptr_t) to the next 8 byte boundary assuming the block is aligned.
			...
			\param ipt	The input pointer as an integer.
			\return		The aligned pointer as an integer.
		...
		*/
		...
		/** Return the address of the vector containing both the attribute keys and the attribute ids in the StringBuffer.
			...
			\return A pointer to the vector containing the attributes.
		...
		*/
		...
		/** Return the address of the StringBuffer containing the strings in the tensor and the attribute values.
			...
			\return A pointer to the StringBuffer.

			NOTE: The StringBuffer is the last part of the Block and contains all the strings in the tensor and the attributes.
			When the Block is created, the StringBuffer is initialized with two zero bytes (STRING_NA and STRING_EMPTY).
		*/
