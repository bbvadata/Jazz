...
StateTransitions state_tr = {
	...
	{PSTATE_CONST_IN_INT,	PSTATE_CONST_IN_INT,	REX_ALL_SPACES},
	{PSTATE_CONST_IN_INT,	PSTATE_CONST_INT,		"[0-9\\-]"},

	{PSTATE_CONST_OUT_INT,	PSTATE_CONST_OUT_INT,	REX_ALL_SPACES},
	...
	{PSTATE_CONST_IN_REAL,	PSTATE_CONST_IN_REAL,	REX_ALL_SPACES},
	{PSTATE_CONST_IN_REAL,	PSTATE_CONST_REAL,		"[0-9\\-]"},

	{PSTATE_CONST_OUT_REAL,	PSTATE_CONST_OUT_REAL,	REX_ALL_SPACES},
	...
	{PSTATE_CONST_IN_STR,	PSTATE_CONST_IN_STR,	REX_ALL_SPACES},
	{PSTATE_CONST_IN_STR,	PSTATE_CONST_STR0,		REX_DOUBLEQUOTE},

	{PSTATE_CONST_OUT_STR,	PSTATE_CONST_OUT_STR,	REX_ALL_SPACES},
...
/*
	...
	{PSTATE_BASE_NAME,		PSTATE_SLASH,			REX_SLASH},

	{PSTATE_CONST_CNTN_NAM,	PSTATE_CONST_CNTN_NAM,	REX_NAME_ANY},
	{PSTATE_CONST_CNTN_NAM,	PSTATE_SLASH,		REX_SLASH},
